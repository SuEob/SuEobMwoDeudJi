    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FbTimeTable.class);
        ...
        aaButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FbSueob.class);
                startActivity(intent);
            }
        });
        ...
        aaaButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FbPost.class);
                startActivity(intent);
            }
        });
